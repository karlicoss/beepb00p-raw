...
To start with, allow me to quote [[https://beepb00p.xyz/orger.html#intro][myself]] here:
...
Aka [[https://beepb00p.xyz/tags.html#quantified-self][#quantified-self]].
...
Aka [[https://beepb00p.xyz/tags.html#offline][#offline]].
...
- Google Takeout data, that is, all your browser activity, Youtube watch history, etc., are only kept by Google for [[https://beepb00p.xyz/./takeout-data-gone.html][few years]]
...
If you consider your digital trace [[https://beepb00p.xyz/tags.html#extendedmind][part of yourself]], this is completely unacceptable. But sadly it's happening all the time.
...
I [[https://beepb00p.xyz/my-data.html][exported/scraped/reverse engineered]] pretty much my entire digital trace and figured out automation and infrastructure which works for me.
...
Higher level querying and access, specific to myself is implemented in [[https://beepb00p.xyz/hpi.html#examples][my.]] package (note that this post is still in draft stage).
...
As a nice byproduct I've also finally figured out a reliable and elegant way to deal with [[https://beepb00p.xyz/mypy-error-handling.html][error handling in Python]].

** how do I use the data?
Finally, some tools and scripts I've implemented to make possible the interactions [[#why][that I want]]:

- A [[https://beepb00p.xyz/pkm-search.html][personal search engine]] for quick incremental search of my data and digital trace
- [[https://beepb00p.xyz/orger.html][orger]]: tool to convert data into org-mode views for instant and offline search and overview
  - [[https://beepb00p.xyz/orger-todos.html#reddit][also]] for prioritizing content consumption (e.g. processing Reddit saves)
  - [[https://beepb00p.xyz/orger-todos.html#krill][also]] for populating my spaced repetition queue
  - [[https://beepb00p.xyz/orger-todos.html#telegram2org][also]] for creating TODOs straight from Telegram messages
- [[https://beepb00p.xyz/./grasp.html][grasp]], browser extension to clip links straight into my org-mode notes
...
I wrote how each specific data source I export contributes to my personal infrastructure [[https://beepb00p.xyz/my-data.html#why][here]].
...
** followups
- *[2020-01-12]* [[https://beepb00p.xyz/my-data.html][What data on myself I collect and why?]]
- *[2020-01-18]* [[https://beepb00p.xyz/scheduler.html][In search of a friendlier scheduler]]
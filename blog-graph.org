...
Click [[https://beepb00p.xyz/./][*this*]] if you want to get back to the plain list.
...
- hovering over a node or clicking on a [[https://beepb00p.xyz/blog-graph.html#pkm-setup][date]] will highlight all connections to the corresponding post, to make the navigation easier

...
I have a [[https://beepb00p.xyz/sad-infra.html][frustration]] around the fact that our personal data is scattered, siloed and incredibly hard
to use for any purposes, not anticipated by the original developers.

[[https://beepb00p.xyz/my-data.html][One of my big efforts]] is unifying all of this scattered data into a system that makes it easier
...
- it hasn't been integrated before [[https://beepb00p.xyz/myinfra.html][in my system]], so it's easy to follow and document all the steps necessary

Throughout the post, I will link to my previous writing on building the [[https://beepb00p.xyz/tags.html#infra][#infra]], so I won't go into explaining every tiny detail and technical rationales here.
...
How to proceed with this knowledge? I apply the principles from [[https://beepb00p.xyz/exports.html#export_layer]["Building data liberation infrastructure"]]:
...
- keep the raw data intact
  ...
  If performance ever becomes an issue, a transparent [[https://beepb00p.xyz/unnecessary-db.html#cachew][caching layer]] can always be added.
...
I've done an overview in [[https://beepb00p.xyz/scheduler.html][this post]], and personally, I'm using an experimental tool, [[https://github.com/karlicoss/dron][dron]], which is basically a nice Systemd frontend.
...
- For me the command looks a bit more sophisticated:
  ...
  I elaborate more on it [[https://beepb00p.xyz/exports.html#arctee][here]], but it's not super crucial for Roam, more of a nice-to-have thing.
...
Say hello to the [[https://beepb00p.xyz/exports.html#dal][data access layer]]!
...
One very useful tool for interacting with my data is [[https://beepb00p.xyz/orger.html][Orger]].
...
- the Emacs search modules
  ...
  - =helm-ripgrep=: I'm using it for a global incremental search (a [[https://beepb00p.xyz/pkm-search.html#snippet_other][single keybinding]] away) over [[https://beepb00p.xyz/pkm-search.html#other][*all*]] of my personal data.

    And if you're still not using [[https://github.com/BurntSushi/ripgrep][ripgrep]], you should seriously give it a try.

  *Typically*, web apps provide a pretty [[https://beepb00p.xyz/sad-infra.html#why_search][pathetic]] search experience.
